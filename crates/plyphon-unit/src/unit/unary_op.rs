...
/// `opAsFloat`/`opAsInt` pass through, matching scsynth's `thru` default for both. Public so
/// SynthDef initialization specialization evaluates operators through this exact table.
