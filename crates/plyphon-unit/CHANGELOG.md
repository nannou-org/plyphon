...
## [0.2.0](https://github.com/nannou-org/plyphon/compare/plyphon-unit-v0.1.1...plyphon-unit-v0.2.0) - 2026-09-26
...
- *(synthdef)* prove allocation-sizing inputs to constants before compile
...
- Pass the chain buffer number through FFT's constructor
...
- Describe the chaos module as matching scsynth throughout
